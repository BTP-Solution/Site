...
export default function ApdWhyUs() {
    return (
            ...
            <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="z-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#ff7700]/10 border border-[#ff7700]/30 mb-8">
                        <span className="text-xs font-medium tracking-wide text-[#ff7700] uppercase">BTP Farkı</span>
                    </div>
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                        Neden <span className="text-[#3463ac]">BTP Solution</span> APD?
                    </h2>
                    <p className="text-lg text-slate-400 mb-8 leading-relaxed">
                        Pasadaki standart fatura okuma araçları, SAP\'nin karmaşık FI/MM süreçlerini
                        anlamakta yetersiz kalır. APD, doğrudan bir SAP entegratörünün kaleminden çıkmıştır.
                    </p>
                    ...
                    <div className="mt-12 p-6 bg-[#060d1a] border border-[#ff7700]/20 rounded-xl relative overflow-hidden">
                        ...
                        <h4 className="text-lg font-bold text-white mb-2">Neden Şimdi?</h4>
                        <p className="text-slate-400 text-sm">
                            Dijital e-dönüşüm zorunlulukları ve artan veri hacimleri, manuel süreçleri
                            artık "yavaş" değil, "sürdürülemez" kılıyor. Finansal çevikliğe bugün geçin.
                        </p>
                    </div>
                </div>
