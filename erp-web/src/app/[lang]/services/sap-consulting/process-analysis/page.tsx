...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generateSeoMetadata({
        lang,
        path: '/services/sap-consulting/process-analysis',
...
export default async function ProcessAnalysisPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    return (
        <main className="w-full flex flex-col bg-[#060d1a]">
            ...
            <ServiceJsonLd name={t.title} description={t.description} lang={lang} path="/services/sap-consulting/process-analysis" />
