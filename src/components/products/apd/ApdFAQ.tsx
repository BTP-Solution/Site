            ...
            <div className="max-w-4xl mx-auto w-full">
                ...
                <div className="space-y-4">
                    {t.items.map((faq, idx) => (
                        ...
                        >
                            <button
                                aria-expanded={openIndex === idx} aria-controls={`apd-faq-${idx}`}
                            ...
                            <div id={`apd-faq-${idx}`} hidden={openIndex !== idx} className={`overflow-hidden transition-all duration-300 ease-in-out ${openIndex === idx ? 'opacity-100' : 'max-h-0 opacity-0'}`}>
